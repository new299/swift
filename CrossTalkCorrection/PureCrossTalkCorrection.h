...
#ifndef SWIFT_PURECROSSTALKCORRECTION_H
#define SWIFT_PURECROSSTALKCORRECTION_H
...
class PureCrossTalkCorrection {
public:

  PureCrossTalkCorrection(int correction_cycle_in,                            ///< Build crosstalk correction based on this cycle
                      ...
                      int purecrosstalk_erode_num_bins_in,
                      int purecrosstalk_purity_highest_how_many_in,
                      string source_signalid_in ="RAW",                 ///< The signal ID to get intensities from
                      string target_signalid_in ="CROSSTALK_CORRECTED", ///< The signal ID to write intensties to
                      ostream &err_in=std::cerr                        ///< Write debug/errors here
                         ...
                         purecrosstalk_erode_num_bins(purecrosstalk_erode_num_bins_in),
                         purecrosstalk_purity_highest_how_many(purecrosstalk_purity_highest_how_many_in),
...
void make_bins(vector<double> &x,             /// X values
  ...
  _prec purity_threshold;                    ///< Threshold for purity filtering
   
  int purecrosstalk_erode_num_bins;
  int purecrosstalk_purity_highest_how_many;
...
#include "PureCrossTalkCorrection.cpp"
